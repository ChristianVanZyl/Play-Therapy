          ...
          <div class="row justify-content-center">
            ...
            <div class="col-sm-6" id="emailCenter">
              <form>
                ...
                <button type="submit" class="btn btn-primary " id="signUpButton">Sign in!</button>
                <a class="btn btn-light btn-sm " href="signUpScreen.php" role="button" id="signUpLinkButton">Not registered yet? Sign up!</a>
              </form>
            </div>
          </div>
          <div class="col-sm-3"></div>
