...
<div class="container-fluid" style="  padding-top: 140px;">
  <nav aria-label="breadcrumb" id="breadCustom">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page" style="color: #95ab9e">Shipping</li>
    </ol>
  </nav>
</div>
<div class='prodMainunderlineDiv'>  </div>
 ...
 <div class="container-fluid" style="padding-top: 3%; padding-left: 15%; padding-right: 15%; padding-bottom: 5%; ">
     ...
     $result = $conn->query($accountInfo);
       ...
       if ($result) {
         while($row = $result->fetch_assoc()) {
           echo
              '<form id="shippingform" method="post" action="backend/orderitem.php"   onsubmit="return shippingSubmitHandler()">
                <div class="form-row">
                ...
                <p  class="orderScreenTitles" style="padding-left: 0">A shipping cost of R180.00 is added to all orders. Shipping is done by Postnet.</p>
                <button  name="submit" value="submit" type="submit" class="btn btn-primary " id="signUpButton">Confirm shipping details</button>
              </form>';
         };
